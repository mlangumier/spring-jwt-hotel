...
public class DataLoader implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    if (userRepository.count() == 0 && roomRepository.count() == 0) {
      User user1 = new User(null, "user@test.com", encoder.encode("password"), Role.USER, true,
          List.of());
      User user2 = new User(null, "admin@test.com", encoder.encode("password"), Role.ADMIN, true,
          List.of());
      ...
      Booking booking1 = new Booking(null, 2, today.plusDays(4), today.plusDays(6),
          room1.getPrice() * 2, user1, List.of(room1));
      Booking booking2 = new Booking(null, 3, today.plusDays(5), today.plusDays(6),
          room2.getPrice() * 2, user1, List.of(room2));
